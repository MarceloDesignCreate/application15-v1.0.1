package com.application.app.modules.clipvoiceconversacomletcia.`data`.model

import com.application.app.R
import com.application.app.appcomponents.di.MyApp
import kotlin.String

data class ClipvoiceConversaComLetCiaModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTimeTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl_0_30)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtTimeThree: String? = MyApp.getInstance().resources.getString(R.string.lbl_16_41)
  ,
  /**
   * TODO Replace with dynamic value
   */
