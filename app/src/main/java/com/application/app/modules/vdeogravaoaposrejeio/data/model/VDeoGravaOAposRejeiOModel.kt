package com.application.app.modules.vdeogravaoaposrejeio.`data`.model

import com.application.app.R
import com.application.app.appcomponents.di.MyApp
import kotlin.String

data class VDeoGravaOAposRejeiOModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTimeTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl_0_40)
  ,
  /**
   * TODO Replace with dynamic value
   */
